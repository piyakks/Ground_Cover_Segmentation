...
IMAGE_DIR   = "./Allowed_in_the_VAL_folder_ONLY"   # folder of color input images
...
def snap_to_patch(size: int, patch: int = 16) -> int:
...
class ImageDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        new_w = max(16, snap_to_patch(orig_w))
        new_h = max(16, snap_to_patch(orig_h))
...
# ============================================================================
from train_segmentation_other_decoder import RCAB, ASPP
...
def main():
    ...
    backbone_model=torch.hub.load("dinov3","dinov3_vitl16",source="local",weights='pretrained/dinov3_vitl16_pretrain_sat493m-eadcf0ff.pth')
    backbone_model.eval()
